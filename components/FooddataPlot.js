...
const FooddataPlot = ({foodApiData,foodImage,foodData}) => { 
  ...
  return (
    foodApiData?<div className='bg-white mt-2 rounded-md p-4 flex flex-col shadow-sm'>
        <div className='flex mb-2 gap-2 flex-wrap'>
                <div className='flex items-center p-1 flex-grow shadow-md border-[#333333] bg-[#333333] border-2 rounded-md '>
                    <Image src={foodImage} height={100} width={100}  alt="Food Image" className="rounded-md shadow-md "/>
                    <div className='flex flex-col ml-2'>
                        <div><span className='text-slate-200'>Food : </span> <span className='text-white' >{foodApiData.item_name}</span></div>
                        <div><span className='text-slate-200'>Type : </span> <span className='text-white' >{foodApiData.item_found}</span></div>    
                        <div><span className='text-slate-200'>Servings : </span> <span className='text-white' >{foodApiData['Servings:']}</span></div>    
                    </div>
                </div>
                <div className='flex items-center justify-center p-1 flex-grow shadow-md border-zinc-100 bg-zinc-100 border-2 rounded-md' >
                    ...
                    <span className='text-[#536976] ml-1'>{foodApiData.Calories}</span>
                </div>
                <div className='flex items-center justify-center p-1 flex-grow shadow-md border-zinc-50 bg-zinc-50 border-2 rounded-md' >
                    ...
                    <span className='text-[#536976] ml-1'>{foodApiData.Calcium}</span>
                </div>
                <div className='flex items-center justify-center p-1 flex-grow shadow-md border-zinc-50 bg-zinc-50 border-2 rounded-md' >
                    <span className='text-[#333333] font-medium' >Iron : </span>
                    <span className='text-[#536976] ml-1'>{foodApiData.Iron}</span>
                </div>
        </div>
    ...
    </div> : <div className='bg-white mt-2 rounded-md p-4 flex flex-col shadow-sm'>
        <div className='flex mb-2 gap-2 flex-wrap'>
                <div className='flex items-center p-1 flex-grow shadow-md border-[#333333] bg-[#333333] border-2 rounded-md '>
